...
func (in *AppTemplateValuesDownwardAPI) DeepCopyInto(out *AppTemplateValuesDownwardAPI) {
	*out = *in
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]DownwardAPIAppTemplateValues, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DownwardAPIAppTemplateValues) DeepCopyInto(out *DownwardAPIAppTemplateValues) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DownwardAPIAppTemplateValues.
func (in *DownwardAPIAppTemplateValues) DeepCopy() *DownwardAPIAppTemplateValues {
	if in == nil {
		return nil
	}
	out := new(DownwardAPIAppTemplateValues)
	in.DeepCopyInto(out)
	return out
}
