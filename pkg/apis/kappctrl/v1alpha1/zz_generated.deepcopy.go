...
func (in *AppTemplateHelmTemplate) DeepCopyInto(out *AppTemplateHelmTemplate) {
	*out = *in
	...
	if in.KubernetesAPIs != nil {
		...
		*out = new(KubernetesGroupVersions)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesGroupVersions) DeepCopyInto(out *KubernetesGroupVersions) {
	*out = *in
	if in.KubernetesGroupVersions != nil {
		in, out := &in.KubernetesGroupVersions, &out.KubernetesGroupVersions
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesGroupVersions.
func (in *KubernetesGroupVersions) DeepCopy() *KubernetesGroupVersions {
	if in == nil {
		return nil
	}
	out := new(KubernetesGroupVersions)
