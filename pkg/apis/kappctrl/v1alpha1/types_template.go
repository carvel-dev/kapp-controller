...
type AppTemplateHelmTemplate struct {
	...
	ValuesFrom []AppTemplateHelmTemplateValuesSource `json:"valuesFrom,omitempty" protobuf:"bytes,4,rep,name=valuesFrom"`
}

// +k8s:openapi-gen=true
type AppTemplateHelmTemplateValuesSource struct {
	SecretRef    *AppTemplateHelmTemplateValuesSourceRef `json:"secretRef,omitempty" protobuf:"bytes,1,opt,name=secretRef"`
	ConfigMapRef *AppTemplateHelmTemplateValuesSourceRef `json:"configMapRef,omitempty" protobuf:"bytes,2,opt,name=configMapRef"`
	Path         string                                  `json:"path,omitempty" protobuf:"bytes,3,opt,name=path"`
}
