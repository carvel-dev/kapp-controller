...
func NewReconciler(fetchFactory fetch.Factory, kcClient kcclient.Interface, pkgClient pkgclient.Interface, coreClient kubernetes.Interface, pkgToPkgInstallHandler *PackageInstallVersionHandler, log logr.Logger) *Reconciler {

	return &Reconciler{fetchFactory: fetchFactory,
		kcClient:               kcClient,
		pkgClient:              pkgClient,
...
func (r *Reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	return NewPackageInstallCR(existingPkgInstall, log, r.kcClient, r.pkgClient, r.coreClient, r.fetchFactory).Reconcile()
}
