...
func Test_SecretRefs_RetrievesAllSecretRefs(t *testing.T) {
	...
	app := apppkg.NewApp(appWithRefs, apppkg.Hooks{}, fetchFac, tmpFac, deployFac, log, apppkg.Opts{}, nil, FakeComponentInfo{}, false)
...
func Test_SecretRefs_RetrievesNoSecretRefs_WhenNonePresent(t *testing.T) {
	...
	app := apppkg.NewApp(appEmpty, apppkg.Hooks{}, fetchFac, tmpFac, deployFac, log, apppkg.Opts{}, nil, FakeComponentInfo{}, false)
