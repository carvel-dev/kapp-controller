	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InstallV1alpha1().InternalPackageVersions().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InstallV1alpha1().InternalPackageVersions().Watch(context.TODO(), options)
			},
		},
		&installpackagev1alpha1.InternalPackageVersion{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *internalPackageVersionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&installpackagev1alpha1.InternalPackageVersion{}, f.defaultInformer)
}
