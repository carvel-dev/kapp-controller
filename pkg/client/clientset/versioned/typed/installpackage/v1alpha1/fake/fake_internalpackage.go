...
var internalpackagesResource = schema.GroupVersionResource{Group: "install.package.carvel.dev", Version: "v1alpha1", Resource: "internalpackages"}

var internalpackagesKind = schema.GroupVersionKind{Group: "install.package.carvel.dev", Version: "v1alpha1", Kind: "InternalPackage"}
...
func (c *FakeInternalPackages) UpdateStatus(ctx context.Context, internalPackage *v1alpha1.InternalPackage, opts v1.UpdateOptions) (*v1alpha1.InternalPackage, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(internalpackagesResource, "status", internalPackage), &v1alpha1.InternalPackage{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.InternalPackage), err
