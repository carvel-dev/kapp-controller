...
type InternalPackageInterface interface {
	...
	UpdateStatus(ctx context.Context, internalPackage *v1alpha1.InternalPackage, opts v1.UpdateOptions) (*v1alpha1.InternalPackage, error)
...
func newInternalPackages(c *InstallV1alpha1Client) *internalPackages {
...
func (c *internalPackages) UpdateStatus(ctx context.Context, internalPackage *v1alpha1.InternalPackage, opts v1.UpdateOptions) (result *v1alpha1.InternalPackage, err error) {
	result = &v1alpha1.InternalPackage{}
	err = c.client.Put().
		Resource("internalpackages").
		Name(internalPackage.Name).
