...
Create(ctx context.Context, package *v1alpha1.Package, opts v1.CreateOptions) (*v1alpha1.Package, error)
Update(ctx context.Context, package *v1alpha1.Package, opts v1.UpdateOptions) (*v1alpha1.Package, error)
...
func (c *packages) Create(ctx context.Context, package *v1alpha1.Package, opts v1.CreateOptions) (result *v1alpha1.Package, err error) {
	result = &v1alpha1.Package{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("packages").
...
func (c *packages) Update(ctx context.Context, package *v1alpha1.Package, opts v1.UpdateOptions) (result *v1alpha1.Package, err error) {
	result = &v1alpha1.Package{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packages").
