...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Revoked) DeepCopyInto(out *Revoked) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Revoked.
func (in *Revoked) DeepCopy() *Revoked {
	if in == nil {
		return nil
	}
	out := new(Revoked)
