...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DependencyType) DeepCopyInto(out *DependencyType) {
	*out = *in
	if in.Package != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DependencyType.
func (in *DependencyType) DeepCopy() *DependencyType {
	if in == nil {
		return nil
	}
	out := new(DependencyType)
	in.DeepCopyInto(out)
	return out
}
