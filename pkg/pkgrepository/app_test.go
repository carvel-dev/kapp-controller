	...
	appWithRefs := v1alpha1.App{
		...
		Spec: v1alpha1.AppSpec{
			...
			Template: []v1alpha1.AppTemplate{
				...
				v1alpha1.AppTemplate{HelmTemplate: &v1alpha1.AppTemplateHelmTemplate{ValuesFrom: []v1alpha1.AppTemplateHelmTemplateValuesSource{{SecretRef: &v1alpha1.AppTemplateHelmTemplateValuesSourceRef{"s7"}}}}}},
		},
	}
