...
# $gen_groups_path \
# 	all github.com/vmware-tanzu/carvel-kapp-controller/pkg/client github.com/vmware-tanzu/carvel-kapp-controller/pkg/apis "kappctrl:v1alpha1 installpackage:v1alpha1 pkg:v1alpha1" \
