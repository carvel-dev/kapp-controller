...
$GOPATH/bin/lister-gen \
  --input-dirs "${KC_PKG}/pkg/apiserver/apis/packages/v1alpha1" \
...
$GOPATH/bin/deepcopy-gen \
  --input-dirs "${KC_PKG}/pkg/apiserver/apis/packages/v1alpha1" \
  --input-dirs "${KC_PKG}/pkg/apiserver/apis/packages" \
  -O zz_generated.deepcopy \
  --go-header-file hack/gen-boilerplate.txt

echo "Generating conversions"
$GOPATH/bin/conversion-gen  \
  --input-dirs "${KC_PKG}/pkg/apiserver/apis/packages/v1alpha1,${KC_PKG}/pkg/apiserver/apis/packages" \
