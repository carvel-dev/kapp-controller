...
func (*MinCoreClient) ResourceV1alpha3() resourcev1alpha3.ResourceV1alpha3Interface {
    panic("Not implemented")
	return nil
}
func (*MinCoreClient) ResourceV1beta1() resourcev1beta1.ResourceV1beta1Interface {
    panic("Not implemented")
    return nil
}
func (*MinCoreClient) ResourceV1beta2() resourcev1beta2.ResourceV1beta2Interface {
    panic("Not implemented")
    return nil
}
func (*MinCoreClient) ResourceV1() resourcev1.ResourceV1Interface {
	panic("Not implemented")
	return nil
}
...
func (*MinDiscoveryClient) ServerVersion() (*version.Info, error) {
	return &version.Info{Major: "1", Minor: "36.0-invalid", GitVersion: "1.36.0-invalid"}, nil
}
