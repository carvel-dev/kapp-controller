	...
	cmd := &cobra.Command{
		...
		Example: cmdcore.Examples{
			cmdcore.Example{"Install a package",
				[]string{"package", "installed", "create", "-i", "sample-pkg-install", "-p", "package.corp.com", "--version", "1.0.0", "-n", "test-ns"},
			},
			cmdcore.Example{"Install package with values file",
				[]string{"package", "installed", "create", "-i", "sample-pkg-install", "-p", "package.corp.com", "--version", "1.0.0", "--values-file", "values.yml", "-n", "test-ns"},
			},
			cmdcore.Example{"Install package and ask it to use an existing service account",
				[]string{"package", "installed", "create", "-i", "sample-pkg-install", "-p", "package.corp.com", "--version", "1.0.0", "--service-account-name", "existing-sa", "-n", "test-ns"}},
...
func NewInstallCmd(o *CreateOrUpdateOptions, flagsFactory cmdcore.FlagsFactory) *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: cmdcore.Examples{
			cmdcore.Example{"Install a package",
				[]string{"package", "install", "-i", "sample-pkg-install", "-p", "package.corp.com", "--version", "1.0.0", "-n", "test-ns"},
			},
			cmdcore.Example{"Install package with values file",
				[]string{"package", "install", "-i", "sample-pkg-install", "-p", "package.corp.com", "--version", "1.0.0", "--values-file", "values.yml", "-n", "test-ns"},
			},
			cmdcore.Example{"Install package and ask it to use an existing service account",
				[]string{"package", "install", "-i", "sample-pkg-install", "-p", "package.corp.com", "--version", "1.0.0", "--service-account-name", "existing-sa", "-n", "test-ns"}},
		}.Description("-i", o.pkgCmdTreeOpts),
		SilenceUsage: true,
		Annotations: map[string]string{cmdapp.TTYByDefaultKey: "",
			cmdcore.PackageManagementCommandsHelpGroup.Key: cmdcore.PackageManagementCommandsHelpGroup.Value},
	...
	cmd := &cobra.Command{
		...
		Example: cmdcore.Examples{
			cmdcore.Example{"Upgrade package install to a newer version",
				[]string{"package", "installed", "update", "-i", "sample-pkg-install", "--version", "1.0.0", "-n", "test-ns"},
			},
			cmdcore.Example{"Update package install with new values file",
				[]string{"package", "installed", "update", "-i", "sample-pkg-install", "--values-file", "values.yml", "-n", "test-ns"}},
			cmdcore.Example{"Update package install to stop consuming supplied values",
				[]string{"package", "installed", "update", "-i", "sample-pkg-install", "--values", "false", "-n", "test-ns"}},
		}.Description("-i", o.pkgCmdTreeOpts),
		SilenceUsage: true,
		Annotations: map[string]string{cmdapp.TTYByDefaultKey: "",
			cmdcore.PackageManagementCommandsHelpGroup.Key: cmdcore.PackageManagementCommandsHelpGroup.Value},
