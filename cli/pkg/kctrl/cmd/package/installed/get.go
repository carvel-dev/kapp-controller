	...
	cmd := &cobra.Command{
		...
		Example: cmdcore.Examples{
			cmdcore.Example{"Get details for a package install",
				[]string{"package", "installed", "get", "-i", "sample-pkg-install", "-n", "test-ns"},
			},
			cmdcore.Example{"View values being used by package install",
				[]string{"package", "installed", "get", "-i", "sample-pkg-install", "--values", "-n", "test-ns"},
			},
			cmdcore.Example{"Download values being used by package install",
				[]string{"package", "installed", "get", "-i", "sample-pkg-install", "--values-file-output", "values.yml", "-n", "test-ns"}},
