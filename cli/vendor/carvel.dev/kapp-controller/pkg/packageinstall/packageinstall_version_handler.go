...
var _ handler.TypedEventHandler[*datapkgingv1alpha1.Package, reconcile.Request] = &PackageInstallVersionHandler{}
...
func (ipvh *PackageInstallVersionHandler) Create(_ context.Context, evt event.TypedCreateEvent[*datapkgingv1alpha1.Package], q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
...
func (ipvh *PackageInstallVersionHandler) Update(_ context.Context, evt event.TypedUpdateEvent[*datapkgingv1alpha1.Package], q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	ipvh.log.Info("enqueueing PackageInstallList")
...
func (ipvh *PackageInstallVersionHandler) Delete(_ context.Context, evt event.TypedDeleteEvent[*datapkgingv1alpha1.Package], q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	ipvh.log.Info("enqueueing PackageInstallList")
	err := ipvh.enqueueEligiblePackageInstalls(q, evt.Object)
	if err != nil {
		ipvh.log.Error(err, "enqueueing all PackageInstalls")
...
func (ipvh *PackageInstallVersionHandler) Generic(_ context.Context, evt event.TypedGenericEvent[*datapkgingv1alpha1.Package], q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
...
func (ipvh *PackageInstallVersionHandler) enqueueEligiblePackageInstalls(q workqueue.TypedRateLimitingInterface[reconcile.Request], obj runtime.Object) error {
